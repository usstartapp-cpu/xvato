=== Xvato — Envato to WordPress Importer ===
Contributors: xvato
...
Import Envato Elements Template Kits into WordPress with one click using the Xvato Chrome Extension.

== Description ==

**Xvato** bridges the gap between Envato Elements and your WordPress site. After Envato discontinued their official WordPress plugin, importing Template Kits became a tedious manual process. Xvato automates the entire workflow.
...
* Xvato Chrome Extension

== Installation ==

1. Upload the `xvato` folder to `/wp-content/plugins/`
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to **Xvato → Settings** for setup instructions
4. Generate an Application Password at **Users → Profile**
5. Install the Xvato Chrome Extension
...
No, but some Template Kits require Elementor Pro features. Xvato will import what it can and flag Pro-only templates.

= Is this official Envato software? =

No. Xvato is an independent tool. It does not bypass any Envato licensing or access controls.
...
Yes! You can manually upload ZIP files via the Xvato dashboard in WordPress admin.
